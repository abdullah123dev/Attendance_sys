							...
							<div class="col-md-12">
								<div class="text-center mb-4" id="log_display"></div>
									<form action="" id="att-log-frm" >
										...
										<center class="btns">
											<button type="button" class='btn btn-sm btn-primary log_now col-sm-2 width_btn' data-id="1">IN AM</button>
											<button type="button" class='btn btn-sm btn-primary log_now col-sm-2 width_btn' data-id="2">OUT AM</button>
											<button type="button" class='btn btn-sm btn-primary log_now col-sm-2 width_btn' data-id="3">IN PM</button>
											<button type="button" class='btn btn-sm btn-primary log_now col-sm-2 width_btn' data-id="4">OUT PM</button>
										</center>
